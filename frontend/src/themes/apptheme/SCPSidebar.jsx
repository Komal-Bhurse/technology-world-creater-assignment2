		...
		<div className="sidebar-container">
			...
			<aside className={`sidebar bg-success text-white shadow-sm ${isOpen ? "open" : "closed p-0"}`}>
				...
				<li className="nav-item ">
						<Link to={() => navigate(-1)} onClick={closeSidebar} className={`nav-link text-white ${isOpen ? "row" : ""}`}>
							<i className="fa fa-arrow-left me-2 col-1"></i> <span className="col-11 ">Back</span>
						</Link>
					</li>
					<hr className="m-0"/>
					<li className="nav-item">
						<Link to="/scp/dashboard" onClick={closeSidebar} className={`nav-link active  ${isOpen ? "row" : ""} ${pathname === "/scp/dashboard" ? "bg-light text-success" : "text-white"}`}>
							<i className="fa fa-info me-2 col-1"></i> <span className="col-11 ">Dashboard</span>
						</Link>
					</li>
					<li className="nav-item">
						<Link to="/scp/farmer-registration" onClick={closeSidebar} className={`nav-link ${pathname === "/scp/farmer-registration" ? "bg-light text-success" : "text-white"} ${isOpen ? "row" : ""}`}>
					...
					<li className="nav-item">
						<Link to="/scp/faqs" onClick={closeSidebar} className={`nav-link  ${isOpen ? "row" : ""} ${pathname === "/scp/faqs" ? "bg-light text-success" : "text-white"}`}>
							<i className="fa fa-question me-2 col-1 "></i> <span className="col-11  ">FAQs</span>
						</Link>
					</li>
					<li className="nav-item">
						<Link to="/scp/privacy-policy" onClick={closeSidebar} className={`nav-link  ${isOpen ? "row" : ""} ${pathname === "/scp/privacy-policy" ? "bg-light text-success" : "text-white"}`}>
							<i className="fa fa-lock me-2 col-1"></i> <span className="col-11 ">Privacy Policy</span>
						</Link>
					</li>
					<li className="nav-item">
						<Link to="/scp/raise-ticket" onClick={closeSidebar} className={`nav-link  ${isOpen ? "row" : ""} ${pathname === "/scp/raise-ticket" ? "bg-light text-success" : "text-white"}`}>
							<i className="fa fa-bug me-2 col-1"></i> <span className="col-11 ">Raise a Ticket</span>
						</Link>
					</li>
					<li className="nav-item">
						<Link to="/scp/conact-info" onClick={closeSidebar} className={`nav-link  ${isOpen ? "row" : ""} ${pathname === "/scp/conact-info" ? "bg-light text-success" : "text-white"}`}>
